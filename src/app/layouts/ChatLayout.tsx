...
export function ChatLayout() {
  ...
  return (
    <div className="flex h-full w-full bg-black overflow-hidden">
      ...
      <div
        className={`flex flex-col h-full bg-black border-r border-[#2f3336] relative overflow-hidden ${
      ...
      >
        ...
        <div className="sticky top-0 z-20 bg-black/65 backdrop-blur-md border-b border-[#2f3336] shrink-0 px-4 py-3">
          ...
          <div className="relative flex items-center">
            <div className="absolute left-3.5 text-[#71767b] pointer-events-none">
            ...
            <input
              ...
              className="h-10 w-full rounded-full bg-[#202327] border border-transparent pl-10 pr-4 text-sm text-[#e7e9ea] placeholder:text-[#71767b] hover:bg-[#272c30] focus:bg-black focus:border-[#1d9bf0] focus:outline-none transition-colors cursor-pointer"
            />
          </div>
        </div>
